...
class _GENERATE_INPUT
{
    ...
    public static function execute()
    {
        ...
        $data                       = [
            ...
            'type'          => isset($variables['page-builder-object-type']) ? $variables['page-builder-object-type'] : '',
        ...
        return json_encode(
            selfRender(self::$module, 'fields' . DIRECTORY_SEPARATOR . 'input/input.generate.php')
        );
    }
    ...
    public static function html($object, $placeholder = true, $options = [])
    {
        ...
        if ($placeholder):
            return selfRender(self::$module, 'fields' . DIRECTORY_SEPARATOR . 'input/input.generate.php');
        else:
            return selfRender(self::$module, 'fields' . DIRECTORY_SEPARATOR . 'input/input.generate-form.php');
        endif;
    }
}