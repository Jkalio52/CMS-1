...
class _GENERATE_CHECKBOX
{
    ...
    public static function execute()
    {
        ...
        return json_encode(
            selfRender(self::$module, 'fields' . DIRECTORY_SEPARATOR . 'checkbox/checkbox.generate.php')
        );
    }
    ...
    public static function html($object, $placeholder = true, $options = [])
    {
        ...
        if ($placeholder):
            return selfRender(self::$module, 'fields' . DIRECTORY_SEPARATOR . 'checkbox/checkbox.generate.php');
        else:
            return selfRender(self::$module, 'fields' . DIRECTORY_SEPARATOR . 'checkbox/checkbox.generate-form.php');
        endif;
    }
}