...
class _GENERATE_IMAGE
{
    ...
    public static function execute()
    {
        ...
        return json_encode(
            selfRender(self::$module, 'fields' . DIRECTORY_SEPARATOR . 'image/image.generate.php')
        );
    }
    ...
    public static function html($object, $placeholder = true, $options = [])
    {
        ...
        if ($placeholder):
            return selfRender(self::$module, 'fields' . DIRECTORY_SEPARATOR . 'image/image.generate.php');
        else:
            return selfRender(self::$module, 'fields' . DIRECTORY_SEPARATOR . 'image/image.generate-form.php');
        endif;
    }
}