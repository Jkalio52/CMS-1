...
class _GENERATE_TEXTAREA
{
    ...
    public static function execute()
    {
        ...
        return json_encode(
            selfRender(self::$module, 'fields' . DIRECTORY_SEPARATOR . 'textarea/textarea.generate.php')
        );
    }
    ...
    public static function html($object, $placeholder = true, $options = [])
    {
        ...
        if ($placeholder):
            return selfRender(self::$module, 'fields' . DIRECTORY_SEPARATOR . 'textarea/textarea.generate.php');
        else:
            return selfRender(self::$module, 'fields' . DIRECTORY_SEPARATOR . 'textarea/textarea.generate-form.php');
        endif;
    }
}