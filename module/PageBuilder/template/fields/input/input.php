<form class="field-container label-design m-0">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                <input type="text" class="form-control" id="page-builder-object-default"
                       name="page-builder-object-default"
                       placeholder="Default Value"
                       value="<?= isset($data['default_value']) ? $data['default_value'] : '' ?>">
                <label for="page-builder-object-default">Default Value</label>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                <input type="text" class="form-control" id="page-builder-object-placeholder"
                       name="page-builder-object-placeholder"
                       placeholder="Placeholder" value="<?= isset($data['placeholder']) ? $data['placeholder'] : '' ?>">
                <label for="page-builder-object-placeholder">Placeholder</label>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                <select class="form-control custom-select required" validation="select" id="page-builder-object-type"
                        name="page-builder-object-type">
                    <option value="">Select Type</option>
                    <? if (!empty($types)): ?>
                        <? foreach ($types as $type): ?>
                            <option value="<?= $type ?>"<?= (isset($data['type']) ? $data['type'] === $type ? ' selected' : '' : '') ?>><?= $type ?></option>
                        <? endforeach; ?>
                    <? endif ?>
                </select>
                <label for="page-builder-object-type">Input Type</label>
            </div>
        </div>
    </div>
