<div class="widget content contact_us_widget page_builder__form">
    <div class="container">
        <div class="row text-<?= $text_align ?> justify-content-<?= $column_align ?>">
            <? switch ($columns):
                case 1:
            ...
            <div class="col-sm-12 <?= $columns ?>">
                <div class="widget__container contact_us_widget__container">
                    <? if (!empty($title)): ?>
                        <h2 class="widget__title contact_us_widget__title">
                            <?= $title ?>
                        </h2>
                    <? endif ?>
                    <? if (!empty($text)): ?>
                        <div class="widget__text contact_us_widget__text">
                            <?= $text ?>
                        </div>
                    <? endif ?>
                    <?= formDisplay($form_id) ?>
