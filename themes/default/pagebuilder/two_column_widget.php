<div class="widget content content__image">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-sm-12 col-md-6 col-lg-6 align-self-center order-2<? if (isset($reverse_order)): if (!$reverse_order): ?> order-md-1<? endif;endif ?>">
                <div class="widget__container content__image__container">
                    ...
                    <div class="widget__button_group content__image__button_group">
                        ...
                        <? endif ?>
                        <? if (isset($button_2) && !empty($button_2['title'])): ?>
            ...
            <div class="col-sm-12 col-md-6 col-lg-6 order-1<? if (!$reverse_order): ?> order-md-2<? endif ?>">
                <? if (!empty($image)): ?>
