<? if (!empty($left_text_widget)): ?>
    <div class="widget content content_simple_long_text">
        <div class="container">
            <div class="row">
                <? foreach ($left_text_widget as $widget):
                    ...
                    <div class="col-sm-12 <?= $columns ?>">
                        <div class="widget__container content_simple_long_text__container">
                            <? if (!empty($widget['headline'])): ?>
                                <h5 class="widget__headline content_simple_long_text__headline mb-2">
                                    <?= $widget['headline'] ?>
                                </h5>
                            <? endif ?>
                            <? if (!empty($widget['title'])): ?>
                                <h2 class="widget__title content_simple_long_text__title mb-3">
                                    <?= $widget['title'] ?>
                                </h2>
                            <? endif ?>
